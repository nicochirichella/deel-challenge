...
export const getClientDebt = async (profileId: number) => {
    const contracts = await ContractService.getActiveContractsForClient(profileId);
...
export const updateBalance = async (depositorProfile: Profile, userId: number, amount: number) => {
